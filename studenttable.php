...
http://localhost/musicon/landing/create.php
               ...
               echo  '<td>'.$batches.'</td>';
               echo  '<td>';
               echo '<a href="delete_student.php?sno=' . $number . '" 
               onclick="return confirm(\'Are you sure you want to delete this faculty member?\')">Delete</a>';
               echo '<a href="studenttable.php?sno=' . $number . '" style="    margin-left: 8px;">Edit</a>';
               echo  '</td>';
              echo  '</tr>';
            }
        } else {
...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['sno'])) {
    ...
    $sql = "SELECT * FROM studenttable WHERE number = '$sno'";
    $result = $conn->query($sql);
    ...
    if ($result->num_rows == 1) {
        ...
        echo '
        <form action="update_student.php" method="POST" style="height:60px;width:300px;">
            <input type="hidden" name="sno" value="' . $sno . '" style="height:30px;width:300px;">
       
            <input type="text" name="name" value="' . $name . '" style="height:30px;width:300px;">
          
            <input type="text" name="batch" value="' . $batch. '" style="height:30px;width:300px;">
            <input type="text" name="batches" value="' . $batches. '" style="height:30px;width:300px;">
