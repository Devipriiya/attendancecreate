...
<div class="form-container">
   ...
   <form action="coursetwodetails.php" method="post" enctype="multipart/form-data">
      ...
      <?php
        ...
        $sql = "SELECT * FROM coursetwodetails";
...
http://localhost/musicon/landing/create.php
     ...
     echo '<a href="coursetwopresent.php?batch='.$batch.'" class="btn" style="background-color:#16a085;color:#fff;border-radius: 22px;
      margin-top: 26px;
      height: 43px;">'.$batch.'</a>';
