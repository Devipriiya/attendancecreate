...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id'])) {
    ...
    $sql = "UPDATE studentdetails SET name = '$name', mobile = '$mobile', email = '$email', gender = '$gender' WHERE id = $id";

    $stmt = $conn->prepare("UPDATE studentdetails SET name = ?, mobile = ?, email = ?, gender = ? WHERE id = ?");
    $stmt->bind_param("ssssi", $name, $mobile, $email, $gender, $id);
